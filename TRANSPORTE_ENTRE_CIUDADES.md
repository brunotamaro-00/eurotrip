...
### Tipos de Acomodación en Nocturnos

| Tipo | Precio pp | Confort | Recomendación |
|------|-----------|---------|---------------|
| Asiento reclinable | $22-44 | Bajo | Solo si presupuesto muy ajustado |
| **Couchette (litera 4-6 pax)** | **$33-66** | **Medio** | **Mejor relación precio/confort** |
| Sleeper (privado 1-2 pax) | $88-165 | Alto | Si el presupuesto lo permite |

### Qué Llevar en el Nocturno
- Tapones de oído + antifaz
- Snacks y agua
- Cargador (enchufes limitados, cargar antes)
...
- Dejar equipaje en consigna de la estación (~$6-8)
...
- Rutas single-track en Highlands: usar passing places, dejar pasar
- GPS: Google Maps funciona bien, descargar offline por zonas sin señal
- Combustible: llenar en ciudades grandes (gasolineras escasas en zonas remotas)
- Estacionamiento en Edimburgo aeropuerto: puede estar incluido la noche del 25

---

## Apps para Transporte

| App | Uso |
|-----|-----|
| **Rail Planner** (Eurail oficial) | Planificar viajes con Eurail |
| **Trainline** | Comprar tickets individuales, comparar precios |
| **Omio** | Comparador trenes + buses + vuelos |
| **Rome2Rio** | Ver todas las opciones entre 2 puntos |
| **Skyscanner** | Vuelos baratos |
| **Waze / Google Maps** | Navegación auto en Highlands |
