...
**Fuente de confirmados:** Spitwise (BBDD productiva). Incluye pagos ya hechos y cuotas `pending` de reservas ya comprometidas. Montos en USD (`amount_usd`).
...
| País | Fechas | Noches | $/noche pp | Total pp | Estado |
|------|--------|--------|-----------|----------|--------|
| Reino Unido — Londres | 5-13 ago | 8 | $37.61 | $300.86 | ✅ Reservado |
| Reino Unido — York | 13-15 ago | 2 | $59.50 | $119.00 | ✅ Reservado |
| Reino Unido — Edimburgo | 15-18 ago | 3 | $45.00 | $135.01 | ✅ Reservado |
| Reino Unido — Highlands | 18-24 ago | 6 | $49.98 (promedio) | $299.87 | ✅ Reservado |
| Reino Unido — Edimburgo tránsito | 24-25 ago | 1 | $61.00 | $61.00 | ✅ Reservado |
| **Reino Unido subtotal** | **5-25 ago** | **20** | | **$915.74** | |
...
**Eurail YA COMPRADO ($370 pp)** · **Eurostar (reserva) YA COMPRADA ($39.44 pp)**

| Concepto | Real / Estimado pp |
|----------|-------------------|
| Eurail Pass (15 días/2 meses) — YA COMPRADO | **$370** |
| Reserva Eurail Eurostar (Ámsterdam→París) — COMPRADA | **$39.44** |
| Tren AMS→París (Katia, pago propio) — COMPRADO | **$39** (solo Katia) |
| Vuelo Edimburgo → Ámsterdam — COMPRADO | **$92.18** |
| Vuelo Sur Italia → Barcelona (aeropuerto flexible) | $15-110 |
| Vuelo **Buenos Aires (BUE) → Londres (LHR)** — Smiles | **$488 (Bruno) / $480 (Katia)** |
| Vuelo **Madrid (MAD) → Buenos Aires (BUE)** — Plus Ultra | **$472.50** |
...
| Concepto | Total | pp |
|----------|-------|-----|
| Tour Harry Potter (Londres) | $138.19 | $69.10 |
| Museo Británico (Londres) | $43.02 | $21.51 |
| Mary King's Close (Edimburgo) | $68.00 | $34.00 |
| Museo Ana Frank (Ámsterdam) | $53.74 | $26.87 |
| **Subtotal actividades confirmadas** | **$302.95** | **$151.48** |
...
### Bruno (108 noches: viaje completo + Portugal)
...
### Gastos Confirmados (Spitwise)

Montos **gross** del hogar (o personales si `payer_only`). Incluye cuotas pendientes de reservas ya hechas.

| Concepto | Total | pp / personal | Split |
|----------|-------|---------------|-------|
| Eurail Pass (x2) | $740.00 | $370.00 | shared |
| Vuelo BUE→LHR Smiles (Bruno) | $488.00 | $488.00 | personal |
| Vuelo BUE→LHR Smiles (Katia) | $480.00 | $480.00 | personal |
| Vuelo MAD→BUE Plus Ultra | $945.00 | $472.50 | shared |
| Seguro Pax Assistance (Bruno) | $320.00 | $320.00 | personal |
| Seguro Pax Assistance (Katia) | $320.00 | $320.00 | personal |
| Londres (8n) | $601.72 | $300.86 | shared |
| York (2n) | $238.00 | $119.00 | shared |
| Edimburgo (3n) | $270.02 | $135.01 | shared |
| Highlands Fort William (2n) | $215.40 | $107.70 | shared |
| Highlands Portree (2n) | $188.06 | $94.03 | shared |
| Highlands Inverness (2n) | $196.28 | $98.14 | shared |
| Edimburgo tránsito (1n) | $122.00 | $61.00 | shared |
| Ámsterdam ClinkMama (4n) | $460.83 | $230.42 | shared |
...
| Interlaken hostel (4n) | $365.32 | $182.66 | shared |
| Auto Highlands | $342.00 | $171.00 | shared |
| Vuelo EDI→AMS | $184.35 | $92.18 | shared |
| Reserva Eurostar AMS→París | $78.88 | $39.44 | shared |
| Tren AMS→París (Katia) | $39.00 | $39.00 | personal |
| Vuelo París→Lisboa (Bruno) | $93.77 | $93.77 | personal |
| Vuelo Porto→Estrasburgo (Bruno) | $90.00 | $90.00 | personal |
| Tour Harry Potter | $138.19 | $69.10 | shared |
| Mary King's Close | $68.00 | $34.00 | shared |
| Museo Británico | $43.02 | $21.51 | shared |
...
## Validación con Experiencias Reales (Reddit)
...
## City Cards / Museum Passes

Resumen rápido de cuáles convienen (verificar precios actuales antes de comprar):

| Ciudad | Pass | Conviene? | Por qué |
|--------|------|-----------|---------|
| Londres | London Pass | NO en general | Solo si hacés 4+ atracciones pagas/día. Muchos museos top son gratis. |
| París | Paris Museum Pass (2 o 4 días) | SI si hacés museos | Louvre + Orsay + Versailles + Sainte-Chapelle en 2 días = ahorro. Skip-the-line incluido. |
| Praga | Prague Card | NO | Ciudad es barata, mejor comprar individual |
| Budapest | Budapest Card (72h) | SI | Termas + transporte público ilimitado + museos. Conviene si usás transporte. |
| Viena | Vienna Pass | NO para 5 días | Muy caro. Mejor comprar atracciones individuales + considerar “standing room” en la ópera (ver precio oficial). |
| Florencia | Firenze Card | Depende | Es €85 (72h). Conviene si van a exprimir 3+ museos “grandes” y evitar colas; sino, comprar individual. |
| Roma | Roma Pass (72h) | SI | Coliseo (skip-the-line) + transporte público + 1 museo extra. |
| Barcelona | NO hay pass útil | NO | Sagrada Familia y Park Güell se compran individual. |
| Madrid | NO hay pass útil | NO | Prado tiene horario gratuito al final del día. |

---

## Tips para Ahorrar

**Alojamiento:** Reservar con anticipación, buscar con cocina, hostales privados en ciudades caras
**Transporte:** Eurail optimizado, trenes nocturnos, vuelos low-cost anticipados, BlaBlaCar
**Comida:** Mercados locales, menú del día (España/Francia), cocinar en hostel, supermercados en Suiza
**Actividades:** Free walking tours, días gratuitos en museos, city cards cuando convengan

---

## Fuentes oficiales (referencia de precios y tickets — Austria→Italia)

### Transporte urbano (tickets)
- Viena (Wiener Linien 1 viaje / validación): `https://www.wienerlinien.at/web/wl-en/single-journey`
- Viena (24h): `https://www.wienerlinien.at/web/wl-en/24-hours-vienna`
- Praga (tarifas DPP): `https://www.dpp.cz/en/fares/fare-pricelist`
- Budapest (BKK 24h travelcard): `https://bkk.hu/en/tickets-and-passes/prices/530-bkk-24-hour-travelcard/`
- Roma (ATAC ROMA24H): `https://www.atac.roma.it/en/tickets-and-passes/roma24h`
- Nápoles (ANM tarifas): `https://www.infopoint.napoli.it/ticket-e-abbonamenti-prezzi/`

### Tickets principales (atracciones)
- Innsbruck Card (precio + qué incluye): `https://www.innsbruck.info/en/sightseeing/innsbruck-card.html`
- Schönbrunn (Palace Ticket): `https://www.schoenbrunn.at/en/all-tickets/grand-tour`
- Belvedere (Upper Belvedere price list): `https://www.belvedere.at/en/prices-ub-shared`
- Széchenyi (precios 2026): `https://www.szechenyibath.hu/prices-2026`
- Auschwitz (price list 2026 PDF): `https://www.auschwitz.org/gfx/auschwitz/userfiles/_public/visit/62_en.pdf`
- Duomo Firenze (Brunelleschi Pass prices): `https://tickets.duomo.firenze.it/en/support/prices`
- Uffizi (tickets): `https://www.uffizi.it/en/tickets`
- Museos Vaticanos (tarifas): `https://www.museivaticani.va/content/museivaticani/en/organizza-visita/tariffe-e-biglietti.html`
