...
- **Altstadt (centro)** — lo mejor para caminar a todo
- **Vauban** — barrio ecológico, tranvía al centro
- **Cerca de Hauptbahnhof** — práctico para day trips en tren

---

## Tip clave (KONUS)

La **KONUS Gästekarte** te da transporte regional/local gratis en Selva Negra, pero **solo si tu alojamiento la emite** (depende de Kurtaxe/municipio).  
Mensaje copy-paste:
