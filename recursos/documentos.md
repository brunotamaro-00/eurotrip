...
| Tramo | Días | Schengen? |
|-------|------|-----------|
| UK (Londres, York, Edimburgo, Highlands) | 20 | NO |
| Zona Schengen (Ámsterdam → fin del viaje, incluyendo Portugal 4-12 sept) | 89 | SI |
| **Total Schengen** | **89** | Dentro del límite |

**Resultado:** 89 días en Schengen (margen 1 día sobre el límite de 90) con Portugal confirmado (**Lisboa + Porto, 4-12 sept**).  
**Nota:** si entre Ámsterdam y Madrid se agregara algún destino fuera de Schengen, el margen aumenta.
...
### Requisitos
- **Duración mínima:** 109 días (5 ago - 21 nov 2026)
...
- **Ruta:** Buenos Aires (BUE) → Londres (LHR) — London Heathrow
- **Compra:** Smiles (millas)
- **Costo:** USD 484 pp
- **Aerolínea:** _por completar_
- **Confirmación:** _por completar_

### Vuelo de Regreso (COMPRADO)
**COMPRADO**
- **Fecha:** 21 noviembre 2026
- **Ruta:** Madrid (MAD) → Buenos Aires (BUE)
...
- Medicamentos personales (suficiente para 109 días)
