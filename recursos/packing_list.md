# Lista de Equipaje - Europa 103 días

## Consideraciones Generales

- **Duración:** 103 días (5 ago - 16 nov 2026)
- **Estaciones:** Verano (agosto) → Otoño (sept-nov)
- **Temperaturas:** 6°C - 25°C
- **Clima:** Variable, de cálido a frío
- **Estrategia:** Ropa liviana y de secado rápido. Capas, lavar ropa regularmente
- **Filosofía:** Priorizar funcionalidad sobre moda. Ropa de frío se compra allá si es necesario (hacia oct-nov)
- **Setup:** Backpacker — todo tiene que entrar en una mochila 50L + mochila chica de día
...
- **Tipo:** Mochila 50L
- **Peso objetivo:** 12-15kg (vas a cargarla en la espalda, que sea manejable)
...
- [ ] 3-4 packing cubes (organizar ropa)
- [ ] 1 bolsa para ropa sucia
- [ ] 1 bolsa impermeable para documentos
- [ ] Ziploc bags (varios tamaños)
...
- [ ] Cargador de laptop 13" (confirmado)
- [ ] Powerbank (mínimo 10,000 mAh)
- [ ] Cable USB-C
- [ ] Cable Lightning (si iPhone)
- [ ] Adaptadores de corriente:
  - [ ] 2 adaptadores Tipo G (UK)
  - [ ] 2 adaptadores Tipo C/F (Europa continental)
  - [ ] Regleta pequeña (opcional, para cargar varios dispositivos)
...
### Productos Básicos (formato viaje / rellenable)
- [ ] Cepillo y pasta de dientes
- [ ] Hilo dental
- [ ] Desodorante
- [ ] Champú sólido / pequeño (o comprar allá)
- [ ] Acondicionador (opcional)
- [ ] Gel de ducha / jabón sólido
...
### Productos Femeninos (si aplica)
- [ ] Copa menstrual / tampones / toallas
- [ ] Analgésicos para cólicos

### Maquillaje (opcional, mínimo)
- [ ] Base / CC cream con SPF
- [ ] Rímel
- [ ] Lo esencial que uses

### Neceser
- [ ] Neceser colgante (fácil acceso en baños compartidos)

**Nota:** Muchos productos se pueden comprar en Europa. No llevar todo de casa.
...
- [ ] Lista de alergias / condiciones
- [ ] Seguro médico (copia impresa)

---

## 📄 Documentos (Carry-on siempre)
...
### Confirmaciones (digital principalmente)
- [ ] Vuelos
- [ ] Alojamientos
- [ ] Transporte pre-comprado
- [ ] Tours/actividades reservadas

### Otros
- [ ] Libreta + bolígrafo
- [ ] Guías de viaje (digital o libro pequeño)
...
### En la mochila chica (carry-on)
- [ ] Laptop 13" + cargador
- [ ] Cambio de ropa interior (por si se pierde la mochila grande)
- [ ] Cepillo de dientes y pasta (formato mini)
- [ ] Powerbank
- [ ] Auriculares
- [ ] Libro / Kindle
- [ ] Almohada de viaje
...
- [ ] Tapones oídos
- [ ] Snacks
- [ ] Botella vacía (rellenar después de seguridad)
- [ ] Suéter / capa extra (aviones fríos)
- [ ] Medicamentos esenciales

### En la riñonera (bolsa personal)
...
- **Ciudades con estadía larga:** Londres (8n), Highlands (7n), Friburgo (7n), Roma (7n), Nápoles (8n), Barcelona (7n)

### Kit de Lavado
- [ ] Detergente en láminas / pods (para lavar a mano si es necesario)
- [ ] Tendedero de viaje / clips
- [ ] Bolsa impermeable (ropa mojada)
...
## ✅ Checklist Final (Antes de Cerrar la Mochila)

- [ ] ¿Puedo levantar la mochila y caminar 10 min cómodo?
- [ ] ¿Peso total de la mochila grande < 15kg?
- [ ] ¿Tengo ropa liviana para agosto-septiembre? (lo de frío se compra allá)
- [ ] ¿Tengo suficiente ropa interior para una semana?
- [ ] ¿Llevé adaptadores de corriente?
- [ ] ¿Todos los líquidos en bolsa transparente (mochila chica)?
- [ ] ¿Pasaporte y documentos en la riñonera?
- [ ] ¿Medicamentos esenciales en la mochila chica?
- [ ] ¿Tengo una muda de ropa en la mochila chica por si se pierde la grande?
- [ ] ¿Candados listos para lockers de hostels?

---

## 📏 Restricciones de Equipaje

### Vuelos (verificar con aerolínea)
- **Mochila 50L (facturada):** Generalmente hasta 23kg — pero apuntar a 12-15kg
- **Mochila chica (carry-on):** 7-10kg, dimensiones ~55x40x23cm
- **Riñonera (bolsa personal):** Debe caber debajo del asiento
- **Líquidos en carry-on:** Bolsa transparente, envases de máx 100ml

### Trenes / Buses Europa
- Sin restricción estricta de peso
- La mochila 50L va en racks superiores o a tus pies
- Debe poder manejarlo solo

---

## 🛍️ Comprar Allá

No todo hay que llevarlo. Europa tiene tiendas baratas (Primark, Decathlon, H&M):
...
### Comprar siempre que haga falta
- Productos de higiene básicos
- Medicamentos comunes (farmacias)
- Paraguas
